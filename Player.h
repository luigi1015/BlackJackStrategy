...
namespace Blackjack
{
	...
	{//A Blackjack player.
		...
		public:
			...
			void split( iterator iteratorPosition );//Splits the hand at the location pointed to by iteratorPosition. Throws an exception if the hand can't be split according to the rules of blackjack.
